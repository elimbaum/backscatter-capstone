...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.signal_freq = signal_freq = 100e3
        self.scatter_center_freq = scatter_center_freq = 200e3
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                1,
                samp_rate,
                fsk_deviation_hz + 2 * fsk_width_hz,
                fsk_width_hz,
                firdes.WIN_HAMMING,
                6.76))
        self.blocks_multiply_xx_0 = blocks.multiply_vcc(1)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/Users/ebaum/Documents/capstone/repo/processing/hamming-test/hamming-dd-bp-s15k.iq', False)
        ...
        self.connect((self.band_pass_filter_0, 0), (self.blocks_file_sink_0, 0))
    ...
    def set_fsk_deviation_hz(self, fsk_deviation_hz):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, self.fsk_deviation_hz - self.fsk_width_hz / 2, self.fsk_deviation_hz + self.fsk_width_hz / 2, self.fsk_width_hz, firdes.WIN_HAMMING, 6.76))
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.fsk_deviation_hz + 2 * self.fsk_width_hz, self.fsk_width_hz, firdes.WIN_HAMMING, 6.76))
    ...
    def set_filter_samp_rate(self, filter_samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(self.center_freq, self.filter_samp_rate)
