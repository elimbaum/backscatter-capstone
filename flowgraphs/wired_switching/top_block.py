...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.freq_offset_coarse = freq_offset_coarse = -20
        ...
        # Blocks
        ##################################################
        self._freq_offset_coarse_range = Range(-60, 0, 1, -20, 200)
        self._freq_offset_coarse_win = RangeWidget(self._freq_offset_coarse_range, self.set_freq_offset_coarse, 'freq_offset_coarse', "counter_slider", float)
        self.top_layout.addWidget(self._freq_offset_coarse_win)
        ...
        self.qtgui_time_sink_x_3.set_trigger_mode(qtgui.TRIG_MODE_FREE, qtgui.TRIG_SLOPE_POS, 0.0, 0, 2, "")
        ...
        self.blocks_multiply_const_vxx_4 = blocks.multiply_const_cc(2000)
        ...
        self.analog_sig_source_x_2 = analog.sig_source_c(filter_samp_rate, analog.GR_COS_WAVE, freq_offset_coarse, 1, 0, 0)
        ...
        self.connect((self.blocks_complex_to_mag_1, 0), (self.qtgui_time_sink_x_3, 0))
        self.connect((self.blocks_copy_0, 0), (self.blocks_complex_to_mag_1, 0))
        self.connect((self.blocks_copy_0, 0), (self.qtgui_const_sink_x_0, 0))
        self.connect((self.blocks_file_source_1, 0), (self.blocks_throttle_0, 0))
        self.connect((self.blocks_multiply_const_vxx_4, 0), (self.blocks_copy_0, 0))
        self.connect((self.blocks_multiply_xx_1, 0), (self.blocks_multiply_const_vxx_4, 0))
        self.connect((self.blocks_multiply_xx_1, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.blocks_null_source_1, 0), (self.qtgui_time_sink_x_3, 2))
        self.connect((self.blocks_null_source_1, 0), (self.qtgui_time_sink_x_3, 1))
        self.connect((self.blocks_null_source_2, 0), (self.qtgui_const_sink_x_0, 1))
    ...
    def set_filter_samp_rate(self, filter_samp_rate):
        ...
        self.set_sps(int(self.filter_samp_rate/self.symbol_rate))
        self.analog_sig_source_x_2.set_sampling_freq(self.filter_samp_rate)
    ...
    def get_freq_offset_coarse(self):
        return self.freq_offset_coarse

    def set_freq_offset_coarse(self, freq_offset_coarse):
        self.freq_offset_coarse = freq_offset_coarse
        self.analog_sig_source_x_2.set_frequency(self.freq_offset_coarse)
