...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.scatter_center_freq = scatter_center_freq = 161632.65
        ...
        self.blocks_udp_sink_0 = blocks.udp_sink(gr.sizeof_char*1, 'localhost', 5555, 100, True)
    ...
    def set_filter_samp_rate(self, filter_samp_rate):
        ...
        self.set_sps(int(self.filter_samp_rate/self.symbol_rate))
        self.qtgui_freq_sink_x_1.set_frequency_range(0, self.filter_samp_rate)
