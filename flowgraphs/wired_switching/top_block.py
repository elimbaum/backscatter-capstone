...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_throttle_1 = blocks.throttle(gr.sizeof_gr_complex*1, filter_samp_rate,True)
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_float*1, 15)
        self.blocks_multiply_const_vxx_2 = blocks.multiply_const_ff(10)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/Users/ebaum/Documents/capstone/repo/processing/hamming-test/hamming-dd-bp-s15k.iq', True, 0, 0)
        ...
        self.connect((self.blocks_multiply_const_vxx_2, 0), (self.qtgui_time_sink_x_1, 1))
        self.connect((self.blocks_repeat_0, 0), (self.blocks_multiply_const_vxx_2, 0))
        self.connect((self.blocks_throttle_1, 0), (self.blocks_copy_0, 0))
    ...
    def set_filter_samp_rate(self, filter_samp_rate):
        ...
        self.set_rrc_taps(firdes.root_raised_cosine(1.0, self.filter_samp_rate, self.symbol_rate, 0.35, 11*self.sps))
        self.set_sps(int(self.filter_samp_rate/self.symbol_rate))
        self.blocks_throttle_1.set_sample_rate(self.filter_samp_rate)
